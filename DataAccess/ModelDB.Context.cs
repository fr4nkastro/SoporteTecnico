...
namespace DataAccess
{
    ...
    public partial class DBEntities : DbContext
    {
        ...
        public virtual DbSet<viewPaquetes> viewPaquetes { get; set; }
        public virtual DbSet<viewServicios> viewServicios { get; set; }
        ...
        public virtual int spAddServicioFull(string nombre, Nullable<double> precio, string tipo)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAddServicioFull", nombreParameter, precioParameter, tipoParameter);
        }
    
        public virtual int spDeleteServiciosFull(Nullable<decimal> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spDeleteServiciosFull", idParameter);
        }
    
        public virtual int spEliminarServicioPaquete(Nullable<int> paquete, Nullable<int> servicio)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spEliminarServicioPaquete", paqueteParameter, servicioParameter);
        }
    
        public virtual ObjectResult<spServiciosEnPaquete_Result> spServiciosEnPaquete(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spServiciosEnPaquete_Result>("spServiciosEnPaquete", iDParameter);
        }
    
        [DbFunction("DBEntities", "fServiciosEnPaquetes")]
        public virtual IQueryable<fServiciosEnPaquetes_Result> fServiciosEnPaquetes(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fServiciosEnPaquetes_Result>("[DBEntities].[fServiciosEnPaquetes](@ID)", iDParameter);
        }
    }
}
