...
namespace DataAccess
{
    ...
    public partial class DBEntities : DbContext
    {
        ...
        public virtual int spAddDetalleFactura(Nullable<decimal> facturaID, Nullable<double> precio, Nullable<double> isv, Nullable<int> cantidad, Nullable<double> total)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAddDetalleFactura", facturaIDParameter, precioParameter, isvParameter, cantidadParameter, totalParameter);
        }
        ...
        public virtual int spAddFacturaServicio(Nullable<decimal> servicioID, Nullable<System.DateTime> fecha, Nullable<decimal> clienteID, string estado, Nullable<decimal> ordenId)
        {
            var servicioIDParameter = servicioID.HasValue ?
                new ObjectParameter("servicioID", servicioID) :
                new ObjectParameter("servicioID", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAddFacturaServicio", servicioIDParameter, fechaParameter, clienteIDParameter, estadoParameter, ordenIdParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> spUpdateContrato(Nullable<decimal> contratoID, Nullable<decimal> clienteID, Nullable<decimal> tecnicoID, Nullable<System.DateTime> fechaFinalizacion, Nullable<System.DateTime> fechaContrato, Nullable<int> retrasos)
        {
            var contratoIDParameter = contratoID.HasValue ?
                new ObjectParameter("contratoID", contratoID) :
                new ObjectParameter("contratoID", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spUpdateContrato", contratoIDParameter, clienteIDParameter, tecnicoIDParameter, fechaFinalizacionParameter, fechaContratoParameter, retrasosParameter);
        }
    
        public virtual int spUpdateDetalleContrato(Nullable<decimal> id, Nullable<decimal> contratoID, Nullable<decimal> servicioID)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateDetalleContrato", idParameter, contratoIDParameter, servicioIDParameter);
        }
    
        public virtual int spUpdateDetalleFactura(Nullable<decimal> id, Nullable<decimal> facturaID, Nullable<decimal> ordenID)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateDetalleFactura", idParameter, facturaIDParameter, ordenIDParameter);
        }
    
        public virtual int spUpdateDetalleOrdenTrabajo(Nullable<decimal> id, Nullable<decimal> ordentrabajoID, Nullable<decimal> tecnicoID, Nullable<decimal> servicioID)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateDetalleOrdenTrabajo", idParameter, ordentrabajoIDParameter, tecnicoIDParameter, servicioIDParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> spUpdateDetallePaquete(Nullable<decimal> id, Nullable<decimal> servicioID, Nullable<decimal> paqueteID, Nullable<decimal> sc, Nullable<decimal> pc)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spUpdateDetallePaquete", idParameter, servicioIDParameter, paqueteIDParameter, scParameter, pcParameter);
        }
    
        public virtual int spUpdateDisponibilidadTecnico(Nullable<decimal> tecnicoID, string estado, Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta)
        {
            var tecnicoIDParameter = tecnicoID.HasValue ?
                new ObjectParameter("tecnicoID", tecnicoID) :
                new ObjectParameter("tecnicoID", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateDisponibilidadTecnico", tecnicoIDParameter, estadoParameter, desdeParameter, hastaParameter);
        }
    
        public virtual int spUpdateFacturaServicio(Nullable<decimal> id, Nullable<decimal> clienteID, Nullable<decimal> servicioID, Nullable<System.DateTime> fecha, string estado, Nullable<decimal> ordenID)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateFacturaServicio", idParameter, clienteIDParameter, servicioIDParameter, fechaParameter, estadoParameter, ordenIDParameter);
        }
